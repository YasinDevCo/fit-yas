...
export default function NewPlanPage() {
  ...
  // const savePlan = () => {
  //   // Validate plan
  //   const hasExercises = Object.values(exercises).some((dayExercises) => dayExercises.length > 0)
  //   if (!hasExercises) {
  ...
  //   toast.textContent = "Workout plan created successfully!"
  ...
  const savePlan = async () => {
    ...
    try {
      const formattedDays = selectedDays.map((day) => ({
        dayOfWeek: weekDays.indexOf(day), // تبدیل "Monday" به 1 و ...
      ...
      toast.textContent = "Workout plan saved successfully!";
      document.body.appendChild(toast);
